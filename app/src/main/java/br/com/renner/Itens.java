...
public class Itens extends PagerAdapter {

    private Context Mcontext;
    private List<Slider> theSlideItemsModelClassList;


    public Itens(Context Mcontext, List<Slider> theSlideItemsModelClassList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        View sliderLayout = inflater.inflate(R.layout.items,null);
        ...
        sliderLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Toast.makeText(Mcontext, "Posição: "+position, Toast.LENGTH_SHORT).show();
               MainActivity.GetVenda(position);
            }
        });
